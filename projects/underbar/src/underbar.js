(function() {
  ...
  _.uniq = function(array, compute) {
    var uniqueArray = [];
    _.each(array, function(value) {
      var computed = compute ? compute(value) : value;
      if(!_.contains(uniqueArray, computed)) {
        uniqueArray.push(computed);
      }
    })
    return uniqueArray;
  };
